...
func NewCollaborator(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("heroku:collaborator/collaborator:Collaborator", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetCollaborator(ctx *pulumi.Context,
	...
	var resource Collaborator
	err := ctx.ReadResource("heroku:collaborator/collaborator:Collaborator", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
