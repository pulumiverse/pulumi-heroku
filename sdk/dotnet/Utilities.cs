...
namespace Pulumiverse.Heroku
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumiverse.Heroku.version.txt");
    ...
    internal sealed class HerokuResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public HerokuResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
